...
window.FM_CONFIG = {
  ...
  slides: [
    ...
    { id: 'demo-expert', block: 4, en: 'Demo — expert review', ar: 'العرض — مراجعة الخبير' },
    { id: 'demo-close', block: 4, en: 'Demo — verified closure', ar: 'العرض — الإغلاق الموثق' },
    { id: 'track-mewa', block: 5, en: 'For Agriculture', ar: 'لوزارة البيئة والمياه والزراعة' },
    { id: 'track-moi', block: 5, en: 'For Interior', ar: 'لوزارة الداخلية' },
    { id: 'track-mod', block: 5, en: 'For Defense', ar: 'لوزارة الدفاع' },
